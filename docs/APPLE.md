...
_Riferimento di stile adottato da ATLAS il 21 agosto 2026. I token in
`styles/tokens.css` sono la traduzione di questo documento: se i due
divergono, vince questo e i token si correggono._
