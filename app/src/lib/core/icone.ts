// icone.ts — GENERATO da `core/icone.js` (stessi tracciati, stessi nomi).
// Si rigenera, non si modifica a mano: l'originale resta la fonte finché
// la app di prima è accesa. Tolto solo `nodoIcona`, che costruiva un
// nodo DOM: qui l'icona la disegna il componente `Icona.svelte`.
//
...
const MASCHERE: Record<string, string> = {
};
 ...
 */
export function icona(nome: string, misura = 24, tratto = 1.7): string {
...
export const esisteIcona = (n: string) => n in TRATTI || n in MASCHERE;
