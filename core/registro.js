...
export async function prendiModulo(id) {
  ...
  const completo = {
    ...
    accentoTesto: voce.accentoTesto || voce.accento,
    accentoPieno: voce.accentoPieno || voce.accento,
