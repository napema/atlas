...
/* ---------------------------------------------------------------------
   Portato da napema/mobility-blueprint senza una modifica. È un catalogo:
   dati, non codice. Le uniche funzioni qui dentro sono ricerche.

   ATTENZIONE: `volumePerGruppo` nei record storici ha per chiave il NOME
   italiano del muscolo, non un id. Rinominare una stringa in `muscoli`
